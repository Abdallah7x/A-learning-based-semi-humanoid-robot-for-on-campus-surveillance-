...
import 'package:tablet/pages/admin_dashboard.dart';

import 'package:tablet/pages/constants.dart'; //import 'package:auth_screen/signin_screen.dart';
...
class WelcomeScreen extends StatelessWidget {
  ...
  Future<void> face_rec2(BuildContext context) async {
    final url = Uri.parse('http://10.0.2.2:5000/name2');
