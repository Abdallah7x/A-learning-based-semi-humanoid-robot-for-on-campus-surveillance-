...
print('probability of the video belonging to class  1 ( fight) =')
y_pred = mymodel.predict(np.array(data_val))[:,1]
print( y_pred[i])
    
    # y_pred = mymodel.predict(np.array(data_val))[:,1]
    # print('probability of the video belonging to class 1 ( not fight) =')
    # print( y_pred[1])
